...
import { LogOut, Trash2, RefreshCw, Lock, AlertCircle, CheckCircle2, X, Search, Users, ChevronRight, BarChart3, Clock, Tag } from "lucide-react";
...
export default function AdminPanel() {
  ...
  const [page,setPage]=useState<"dashboard"|"contacts"|"detail"|"tarifas">("dashboard");
  ...
  const navItems=[["dashboard","Dashboard",<BarChart3 key="d" className="w-4 h-4"/>],["contacts","Contactos",<Users key="c" className="w-4 h-4"/>],["tarifas","Tarifas",<Tag key="t" className="w-4 h-4"/>]] as const;
